          ...
          <AnimatePresence mode="popLayout" initial={false}>
            {open && (
              ...
              >
                ...
                {(loading || error || content?.description || content?.resources?.length) && (
                    ...
                    {!loading && !error && (content?.description || content?.resources?.length) && (
                      <div className="max-h-[260px] overflow-auto pr-1">
                            ...
                            <div className="space-y-2">
                              {content.resources.map((r) => (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noreferrer"
                                  className="block text-xs text-white/80 hover:text-white underline underline-offset-4"
                                >
                                  [{r.type}] {r.title}
                                </a>
                              ))}
                        ...
                        {content?.contribution ? (
                          <a
                            href={content.contribution}
                            target="_blank"
                            rel="noreferrer"
                            className="mt-3 inline-block text-xs text-white/70 hover:text-white underline underline-offset-4"
                          >
                            Contribute / source
                          </a>
                        ) : null}
